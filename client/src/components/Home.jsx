...
export default function Home() {
  ...
  return (
    <div className="Home">
      <div className="container">
        <main id="#">
          <div className="description" data-aos="fade-up" data-aos-delay="350">
            <div className="hero-description">
              Top Freelancers And Services At Your Fingertips
            </div>
            <p>
              Whether you're a business looking for support or a freelancer
        ...
        <section>
          <div className="services" id="services">
            <div className="custom-headline">Services</div>
            <div className="service">
              ...
              <div className="service-description">
                ...
                <div className="service-info" data-aos="fade-up">
                  Whether you need a custom website built from scratch, an
                  existing website redesigned, or ongoing maintenance and
                  updates, we have the skills and experience to get the job done
                </div>
              </div>
            </div>
            <div className="service">
              ...
              <div className="service-description reverse">
                ...
                <div className="service-info" data-aos="fade-right">
                  ...
                  and individuals create an online presence that is both
            ...
            <div className="service">
              ...
              <div className="service-description">
                ...
                <div className="service-info" data-aos="fade-up">
                  If you're in need of high-quality apps for IOS and Android,
                  our developers have the skills and expertise to make it
                  happen.
                </div>
              </div>
            </div>
          ...
          <div className="about-us" id="aboutus">
            ...
            <div className="about-us-description reverse">
              ...
              <div className="about-us-info" data-aos="fade-right">
                At MindLancers, our team is dedicated to making sure that every
                client is completely satisfied with the work we do. Whether
                you're looking for a new website, marketing materials, or any
                other type of service, we'll work with you to understand your
                needs and goals, and then create a customized solution that
                meets your unique requirements.
              </div>
            </div>
          </div>
          <div className="contact-us" id="contactus">
            <div className="custom-headline">Contact Us</div>
      ...
      <footer>
        <div className="footer-head">MindLancer</div>
        <p className="footer-body">
          MindLancer is a leading provider of freelance services, connecting
          talented individuals with clients who need their skills and expertise.
          From website design and development to writing and marketing, our team
          has the knowledge and experience to help you succeed.
        </p>
        <div className="footer-footer">
          <div className="copyright">
            Copyright MindLancer ©2025 | All Rights Reserved
          </div>
